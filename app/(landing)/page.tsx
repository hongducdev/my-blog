  ...
  return (
    <div>
      <div className="relative h-[280px]">
        ...
        <div className="absolute z-[3] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
          <h1 className="text-5xl font-bold">Hồng Đức Dev</h1>
          <p className="text-xl font-medium mt-2">
            Blog chia sẻ bài tập, những kinh nghiệm mà mình tích lữy được trong
